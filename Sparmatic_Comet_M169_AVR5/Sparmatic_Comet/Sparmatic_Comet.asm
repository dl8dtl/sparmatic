...
MainLoop:
 ...
 cbi	SSPI_PORT, SSPI_MOSI				;generate low level to wake up external peripheral
 sbi	SSPI_DDR, SSPI_MOSI
 nop
 nop
 nop
 nop
 ...
 cbi	SSPI_DDR, SSPI_MOSI	
 sbi	SSPI_PORT, SSPI_MOSI				;enable pullup, level on MOSI rises
...
_ML1:
 ...
 andi	Temp, 0b10000001					;any rotary pin is connected to GND, disable corresponding pullup to save power (~150µA worst case)
...
.include	"ADC.inc"
.include	"RTC.inc"
.include	"ExternalPeripheral.inc"
